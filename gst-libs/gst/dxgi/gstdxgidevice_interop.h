...
#define GST_DXGI_DEVICE_INTEROP_CLASS(k)        (G_TYPE_CHECK_CLASS((k), GST_TYPE_DXGI_DEVICE_INTEROP, GstDXGIDeviceClass))
...
#define GST_DXGI_DEVICE_INTEROP_GET_CLASS(o)    (G_TYPE_INSTANCE_GET_CLASS((o), GST_TYPE_DXGI_DEVICE_INTEROP, GstDXGIDeviceClass))
